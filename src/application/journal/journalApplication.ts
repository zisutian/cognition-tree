...
export type JournalSystemRepositorySession = Pick<
...
export function requireJournalContent(
  ...
  if (content.purpose !== "system-journal") {
    throw new Error("The journal application received non-journal content.");
  }
...
export function createJournalMutationActions({
  ...
  session: Pick<JournalSystemRepositorySession, "updateContent">;
