...
export const adminApiOperations = [
  ...
  { access: ownerAccess(), body: apiBody(AgentCodexDeviceLoginRequestSchema), method: "POST", operationId: "startAgentCodexDeviceLogin", path: "/api/v3/admin/agent-providers/{providerId}/codex-device-logins", responses: { 202: AgentCodexDeviceLoginStatusSchema } },
  { access: ownerAccess(), body: apiBody(AgentConfigurationDeleteRequestSchema), method: "DELETE", operationId: "clearAgentProviderAuthentication", path: "/api/v3/admin/agent-providers/{providerId}/authentication", responses: { 200: AgentConfigurationSnapshotSchema } },
  { access: ownerAccess(), method: "GET", operationId: "getAgentCodexDeviceLogin", path: "/api/v3/admin/agent-codex-device-logins/{codexLoginId}", responses: { 200: AgentCodexDeviceLoginStatusSchema } },
  { access: ownerAccess(), method: "DELETE", operationId: "cancelAgentCodexDeviceLogin", path: "/api/v3/admin/agent-codex-device-logins/{codexLoginId}", responses: { 200: AgentCodexDeviceLoginStatusSchema } },
  ...
  { access: ownerAccess(), body: apiBody(AgentConformanceCheckRequestSchema), method: "POST", operationId: "startAgentProfileConformanceCheck", path: "/api/v3/admin/agent-profiles/{profileId}/conformance-checks", responses: { 202: AgentConformanceCheckStatusSchema } },
  { access: ownerAccess(), method: "GET", operationId: "getAgentProfileConformanceCheck", path: "/api/v3/admin/agent-conformance-checks/{conformanceCheckId}", responses: { 200: AgentConformanceCheckStatusSchema } },
  { access: ownerAccess(), method: "DELETE", operationId: "cancelAgentProfileConformanceCheck", path: "/api/v3/admin/agent-conformance-checks/{conformanceCheckId}", responses: { 200: AgentConformanceCheckStatusSchema } },
