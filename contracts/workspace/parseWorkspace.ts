...
/**
 * A repository note id is also used as a storage-owned metadata key. Keep
 * this rule in the wire contract so HTTP and local persistence reject the
 * same content before any write begins.
 */
