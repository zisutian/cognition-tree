...
} & ActivityControllerProps<WorkbenchApplication> &
  Omit<SyntaxActivityControllerProps, keyof ActivityControllerProps<unknown>>;

export type ActivityDescriptor = ActivityNavigationItem & {
  Controller: LazyExoticComponent<
    ComponentType<WorkbenchActivityControllerProps>
  >;
};
...
export const activityDescriptors: readonly ActivityDescriptor[] = [
  {
    Controller: lazy(async () => {
      const { NotesActivityController } = await import(
        "../../activities/notes/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          ...
          return (
            <NotesActivityController
              ...
              application={{
                repository: {
                  activeDescriptor: application.repository.activeDescriptor,
                  session: application.repository.session,
                },
                workspace: application.workspace,
              }}
              onActiveActivityChange={props.onActiveActivityChange}
              renderActivity={props.renderActivity}
            />
          );
        },
      };
  ...
  {
    Controller: lazy(async () => {
      const { JournalActivityController } = await import(
        "../../activities/journal/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
          return (
            <JournalActivityController
              ...
              application={{
                ...
                repository: { builtIns: application.repository.builtIns },
              }}
              onActiveActivityChange={props.onActiveActivityChange}
              renderActivity={props.renderActivity}
            />
  ...
  {
    Controller: lazy(async () => {
      const { TodoActivityController } = await import(
        "../../activities/todo/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
  ...
  {
    Controller: lazy(async () => {
      const { SyntaxActivityController } = await import(
        "../../activities/syntax/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
                ...
                journal:
                  application.journal.status === "ready"
                    ? {
                        status: "ready",
                        view: {
                          syntax: application.journal.view.syntax,
                          diagnostics: application.journal.view.diagnostics,
                        },
                      }
                    : { status: application.journal.status },
                todo:
                  application.todo.status === "ready"
                    ? {
                        status: "ready",
                        view: {
                          syntax: application.todo.view.syntax,
                          diagnostics: application.todo.view.diagnostics,
                        },
                      }
                    : { status: application.todo.status },
                workspace: application.workspace,
              }}
              onActiveActivityChange={props.onActiveActivityChange}
              renderActivity={props.renderActivity}
              onSyntaxLeaveBlockedChange={props.onSyntaxLeaveBlockedChange}
              onSyntaxProblemsChange={props.onSyntaxProblemsChange}
              systemSyntaxFocusRequest={props.systemSyntaxFocusRequest}
  ...
  {
    Controller: lazy(async () => {
      const { SearchActivityController } = await import(
        "../../activities/search/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
          return (
            <SearchActivityController
              ...
              application={{
                repository: {
                  catalogState: application.repository.catalogState,
                },
  ...
  {
    Controller: lazy(async () => {
      const { RepositoryActivityController } = await import(
        "../../activities/repository/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
  ...
  {
    Controller: lazy(async () => {
      const { SettingsActivityController } = await import(
        "../../activities/settings/index.ts"
      );
      return {
        default: (props: WorkbenchActivityControllerProps) => {
          const { application } = props;
